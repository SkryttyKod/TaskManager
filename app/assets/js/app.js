// Estado compartido de la interfaz para tareas y modal activo.
const estadoAplicacion = {
    grupos: [],
    idGrupoActivo: null,
    modoModal: 'edicion-tareas',
...
function manejarClicModal(event) {
    ...
    if (accion === 'cancelar-edicion-grupo') {
        abrirModalGrupo(Number(boton.dataset.id), 'edicion-tareas');
        return;
    }
 ...
 * @param {string} [modo='edicion-tareas'] Vista del modal que se debe renderizar.
 * @returns {void} No retorna datos.
 */
function abrirModalGrupo(idGrupo, modo = 'edicion-tareas') {
...
function cerrarModal() {
    ...
    estadoAplicacion.modoModal = 'edicion-tareas';
}
 ...
 * @returns {DocumentFragment} Fragmento con la información y controles correspondientes.
 */
